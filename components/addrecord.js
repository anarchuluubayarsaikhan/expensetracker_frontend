...
import { Calendar as CalendarIcon, ZoomIn } from "lucide-react"
...
export function  Record ({category, icon, color}) {
                                                        ...
                                                        {category.map ((cat) => (
                                                            <SelectItem value={cat.id} >
                                                                ...
                                                                <div className="flex items-center gap-3">
                                                                    ...
                                                                    <div style={{color:cat.color}}>{icon.find ((item)=> item.value === cat.icon).iconi}</div>
